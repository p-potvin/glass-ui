            ...
            <div className="w-64 flex flex-col gap-2">
              <div className="flex items-center justify-between gap-2">
                <select
                  ...
                  className="rounded-lg border border-[#93a1a1]/20 bg-[#eee8d5] px-2 py-1 text-[#657b83] text-sm outline-none w-32 cursor-pointer focus-visible:ring-2 focus-visible:ring-[#268bd2]"
                >
                  {variants.map((v) => (
                ...
                <input
                  ...
                  className="w-9 h-9 rounded-md border border-[#93a1a1]/20 p-0 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#268bd2]"
                />
              </div>

              <div className="flex items-center gap-2">
                <label htmlFor="designer-opacity" className="text-xs text-[#586e75]">Opacity</label>
                <input
                  id="designer-opacity"
                  type="range"
                  min={0}
                  ...
                  data-no-drag
                  className="h-2 w-28 accent-[#268bd2] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#268bd2] rounded-full"
                />
                <div className="text-xs text-[#657b83]">{Math.round(tintOpacity * 100)}%</div>
              </div>

              <div className="flex items-center gap-2">
                <label htmlFor="designer-blur" className="text-xs text-[#586e75]">Blur</label>
                <input
                  id="designer-blur"
                  type="range"
                  min={0}
              ...
              <div className="flex items-center gap-2">
                <label htmlFor="designer-radius" className="text-xs text-[#586e75]">Radius</label>
                <input
                  id="designer-radius"
                  type="range"
                  min={0}
              ...
              <div className="flex items-center justify-between gap-2">
                <label className="flex items-center gap-2 text-sm text-[#586e75] cursor-pointer">
                  Shadow
                  <input
                    type="checkbox"
                    checked={shadow}
                    ...
                    data-no-drag
                    className="h-4 w-4 accent-[#268bd2] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#268bd2] focus-visible:ring-offset-1"
                  />
                </label>
                ...
                <button
                  onClick={copyCss}
                  data-no-drag
                  className="rounded-md bg-[#268bd2] px-3 py-1 text-sm font-medium text-white hover:bg-[#2aa198] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#268bd2] focus-visible:ring-offset-2 transition-colors cursor-pointer"
                >
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    value={variant}
                    onChange={(e) => setVariant(e.target.value as GlassVariant)}
                    className="rounded-lg border border-[#93a1a1]/20 bg-[#eee8d5] px-2 py-1 text-[#657b83] outline-none text-sm w-36 cursor-pointer focus-visible:ring-2 focus-visible:ring-[#268bd2]"
                  >
                    {variants.map((v) => (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input id="sticky-tint" type="color" value={stickyTint} onChange={(e) => setStickyTint(e.target.value)} className="w-8 h-8 rounded-md border border-[#93a1a1]/20 p-0 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#268bd2]" />
                </div>
                <div className="flex items-center gap-2">
                  <label htmlFor="sticky-opacity" className="text-xs text-[#586e75] w-12">Opacity</label>
                  <input id="sticky-opacity" type="range" min={0} max={100} value={Math.round(stickyTintOpacity * 100)} onChange={(e) => setStickyTintOpacity(Number(e.target.value) / 100)} className="h-2 w-24 accent-[#268bd2] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#268bd2] rounded-full" />
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input id="sticky-blur" type="range" min={0} max={40} value={stickyBlurPx} onChange={(e) => setStickyBlurPx(Number(e.target.value))} className="h-2 w-24 accent-[#268bd2] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#268bd2] rounded-full" />
