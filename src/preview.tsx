    ...
    <div className="flex flex-col gap-6 p-8 bg-surface shadow-md rounded-xl max-w-2xl w-full mx-auto mt-12 border border-surface-alt">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button
          ...
          className="flex flex-col items-start p-6 bg-primary hover:bg-surface-alt hover:shadow-sm transition-all rounded-lg border border-surface-alt group cursor-pointer text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
    ...
    <div className="flex flex-col min-h-screen">
      <header className="p-4 flex items-center justify-between bg-surface shadow-sm sticky top-0 z-10 border-b border-surface-alt">
        ...
        <button
          ...
          className="px-4 py-2 text-sm font-medium text-surface bg-accent hover:bg-accent-muted transition-colors rounded-md shadow-sm cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-surface focus-visible:ring-accent"
        >
          Back to Menu
        </button>
      </header>
